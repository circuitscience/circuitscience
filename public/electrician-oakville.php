...
<head>
  ...
  <title>Electrician Oakville | Circuit Science Inc.</title>
  <meta name="description" content="Electrician in Oakville, ON. Circuit Science Inc. offers residential, commercial and healthcare electrical work, repairs and upgrades for Oakville homeowners and businesses.">
  <meta name="robots" content="index,follow">
  <link rel="canonical" href="https://www.circuitscience.ca/electrician-oakville">
  ...
  <main id="main">
    <section class="hero" style="min-height: 360px;">
      ...
      <div class="wrap hero-content">
        <p class="eyebrow">Electrician in Oakville</p>
        <h1>Practical electrical service for Oakville homes and businesses.</h1>
        <p class="hero-copy">From panel upgrades and troubleshooting to lighting improvements, Circuit Science helps Oakville property owners solve electrical problems without unnecessary upselling or confusion.</p>
    ...
    <section class="estimate section" id="estimate">
      <div class="wrap estimate-grid">
        <div class="estimate-copy">
          ...
          <h2>Need an electrician in Oakville?</h2>
          <p>Let us know what is happening and Jerry will follow up with the best next step.</p>
